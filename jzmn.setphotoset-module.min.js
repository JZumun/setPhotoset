...
return t.setPhotoset=function t(n,a,s){if(s=s||Math.floor(1e5*Math.random()+1).toString(),!n)throw new Error("[setPhotoset] Argument cannot be null.")
if(n.toString()===n)return t(document.querySelectorAll(n),a,s)
if(n.length)return Array.prototype.map.call(n,function(e,r){t(e,a,s)})
if(!n.nodeType)throw new Error("[setPhotoset] Argument is not an Element")
a=a||{}
var l={layout:0,immediate:!1,childItem:"img",childHeight:"height",childWidth:"width",gutter:0,callback:null,createSheet:!0}
return Object.keys(a).map(function(t){t in l&&(l[t]=a[t])}),l.gutter=l.gutter?l.gutter.toString()===l.gutter?l.gutter:l.gutter+"px":null,l.createSheet&&o(l,s),l.immediate||"img"!=l.childItem?r(n,l,s):e(n,r,[n,l,s]),n},t.extendFn&&t.extendFn({setPhotoset:t.setPhotoset}),t}(jzmn||{})
